...
//        }
    ...
    @ApiOperation("/上传二级商品分类的图片")
    @RequestMapping(value = "/uploadPicture",method = RequestMethod.POST)
    @ResponseBody
    public CommonResult<String > uploadPicture(@RequestParam MultipartFile file){
        String newPicPath = uploadService.uploadPicture(file, "/upload/product_category");
        if("".equals(newPicPath)){
            return CommonResult.failed("文件上传失败");
        }
        return CommonResult.success(newPicPath);
    }
}
