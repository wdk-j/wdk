...
-- ----------------------------
-- Table structure for pms_home_category
-- ----------------------------
DROP TABLE IF EXISTS `pms_home_category`;
CREATE TABLE `pms_home_category` (
  `id` int(32) NOT NULL AUTO_INCREMENT,
  `category_name` varchar(255) DEFAULT NULL COMMENT '分类名称',
  `img_url` varchar(255) DEFAULT NULL,
  `turn_url` varchar(255) DEFAULT NULL COMMENT '跳转页面配置',
  `module` int(255) DEFAULT NULL COMMENT '模板：1、单排分类  2、双排分类 ',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of pms_home_category
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Table structure for sms_advice
-- ----------------------------
DROP TABLE IF EXISTS `sms_advice`;
CREATE TABLE `sms_advice` (
  `id` int(32) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT NULL COMMENT '主题',
  `img_url` varchar(255) DEFAULT NULL COMMENT '活动背景',
  `turn_url` varchar(255) DEFAULT NULL COMMENT '跳转详情',
  `content` text DEFAULT NULL COMMENT '内容描述',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of sms_advice
-- ----------------------------
BEGIN;
COMMIT;
...
-- ----------------------------
-- Table structure for tms_coupon
-- ----------------------------
DROP TABLE IF EXISTS `tms_coupon`;
CREATE TABLE `tms_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `min_point` int(11) DEFAULT NULL COMMENT '使用门槛；0表示无门槛',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='外卖优惠券';

-- ----------------------------
-- Records of tms_coupon
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for tms_food
-- ----------------------------
DROP TABLE IF EXISTS `tms_food`;
CREATE TABLE `tms_food` (
  `food_id` int(11) NOT NULL AUTO_INCREMENT,
  `food_name` varchar(255) DEFAULT NULL COMMENT '食品名称',
  `price` decimal(10,2) DEFAULT NULL COMMENT '价格',
  `mark` decimal(3,1) DEFAULT NULL COMMENT '评分',
  `discount` decimal(3,1) DEFAULT NULL COMMENT '折扣',
  `main_materials` varchar(255) DEFAULT NULL COMMENT '主料',
  `has_meat` varchar(255) DEFAULT NULL COMMENT '荤素',
  `weight` double DEFAULT NULL COMMENT '重量',
  `intro` varchar(255) DEFAULT NULL COMMENT '卖家描述',
  `packing_fee` double DEFAULT NULL COMMENT '包装费',
  `seller_id` int(11) DEFAULT NULL COMMENT '外键',
  `is_delete` varchar(1) DEFAULT NULL COMMENT '上下架 1为下架',
  PRIMARY KEY (`food_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外卖食品表';
...
-- ----------------------------
-- Table structure for tms_food_comments
-- ----------------------------
DROP TABLE IF EXISTS `tms_food_comments`;
CREATE TABLE `tms_food_comments` (
  `comm_id` int(32) NOT NULL AUTO_INCREMENT,
  `content` text DEFAULT NULL COMMENT '评论内容',
  `post_time` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp() COMMENT '评论时间',
  `user_id` int(32) DEFAULT NULL COMMENT '评论人ID',
  `food_id` int(32) DEFAULT NULL COMMENT '食物ID',
  `reply` varchar(255) DEFAULT NULL COMMENT '答复',
  PRIMARY KEY (`comm_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外卖评论表';

-- ----------------------------
-- Records of tms_food_comments
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for tms_food_comments_pics
-- ----------------------------
DROP TABLE IF EXISTS `tms_food_comments_pics`;
CREATE TABLE `tms_food_comments_pics` (
  `pic_id` int(32) NOT NULL AUTO_INCREMENT,
  `pic_url` varchar(255) DEFAULT NULL COMMENT '图片网络地址',
  `pic_desc` varchar(255) DEFAULT NULL COMMENT '图片描述',
  `comm_id` int(32) DEFAULT NULL COMMENT '评论ID',
  PRIMARY KEY (`pic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外卖食品评论图片表';

-- ----------------------------
-- Records of tms_food_comments_pics
-- ----------------------------
BEGIN;
COMMIT;

-- ----------------------------
-- Table structure for tms_food_pics
-- ----------------------------
DROP TABLE IF EXISTS `tms_food_pics`;
CREATE TABLE `tms_food_pics` (
  `pic_id` int(32) NOT NULL AUTO_INCREMENT,
  `pic_url` varchar(255) DEFAULT NULL COMMENT '图片网络地址',
  `pic_desc` varchar(255) DEFAULT NULL COMMENT '图片描述',
  `is_main` varchar(32) DEFAULT NULL COMMENT '是否主图：0非主图，1主图',
  `food_id` int(32) DEFAULT NULL COMMENT '食品外键',
  PRIMARY KEY (`pic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外卖食品图片表';

-- ----------------------------
-- Records of tms_food_pics
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE `tms_order` (
  ...
  `post_time` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp() COMMENT '提交时间',
  `address_id` int(32) DEFAULT NULL COMMENT '配送地址外键',
  `user_id` int(32) DEFAULT NULL COMMENT '用户ID',
  `pack_fee` double DEFAULT NULL COMMENT '包装费',
  `delivery_fee` double DEFAULT NULL COMMENT '配送费',
  `payment` double DEFAULT NULL COMMENT '实付金额',
  `memo` varchar(255) DEFAULT NULL COMMENT '备注',
  `coupon_id` int(11) DEFAULT NULL COMMENT '优惠券外键',
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外卖订单表';
...
CREATE TABLE `tms_order_detail` (
  `od_id` int(32) NOT NULL AUTO_INCREMENT,
  `food_id` int(32) DEFAULT NULL COMMENT '食品ID',
  `order_id` int(32) DEFAULT NULL COMMENT '订单ID',
  `amount` varchar(255) DEFAULT NULL COMMENT '订购数量',
  `memo` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`od_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='外卖订单明细表';
...
-- ----------------------------
-- Table structure for tms_seller
-- ----------------------------
DROP TABLE IF EXISTS `tms_seller`;
CREATE TABLE `tms_seller` (
  `seller_id` int(32) NOT NULL AUTO_INCREMENT,
  `seller_name` varchar(255) DEFAULT NULL COMMENT '卖家名称',
  `tel` varchar(255) DEFAULT NULL COMMENT '联系电话',
  `logo_url` varchar(255) DEFAULT NULL COMMENT '卖家Logo',
  `intro` text DEFAULT NULL COMMENT '卖家介绍',
  `addr_id` bigint(20) DEFAULT NULL COMMENT '卖家地址ID',
  `min_price` decimal(10,2) DEFAULT NULL COMMENT '起送价格',
  `closed` varchar(1) DEFAULT NULL COMMENT '是否打烊：1打烊，0未打烊',
  `is_delete` varchar(32) DEFAULT NULL COMMENT '是否删除：0未删除，1删除',
  PRIMARY KEY (`seller_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tms_seller
-- ----------------------------
BEGIN;
COMMIT;
...
INSERT INTO `ums_admin_login_log` VALUES (196, 3, '2020-06-01 13:23:48', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (197, 3, '2020-06-01 13:57:41', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (198, 3, '2020-06-01 13:58:51', '0:0:0:0:0:0:0:1', NULL, NULL);
COMMIT;
...
-- ----------------------------
-- Table structure for ums_browser_history
-- ----------------------------
DROP TABLE IF EXISTS `ums_browser_history`;
CREATE TABLE `ums_browser_history` (
  `id` int(32) NOT NULL AUTO_INCREMENT,
  `member_id` int(64) DEFAULT NULL,
  `product_id` int(64) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ums_browser_history
-- ----------------------------
BEGIN;
COMMIT;
